    ...
    <div className="relative w-full h-125 lg:h-145 xl:min-h-screen   overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col mt-10 lg:-mt-32  justify-center h-full text-white px-4 sm:px-6 md:px-10 lg:px-16 2xl:pt-[5%] lg:pt-[35%] xl:pt-[28%]">
        ...
        <div className="max-w-360 w-full mx-auto">
          ...
          >
            A Voice-First Productivity App That
            <br />
            {}
            <span className="text-[#FF9500]"> Turns Speech Into Action</span>
          </h1>
          <PageSubtitle
            text="SayTask is a conversational AI-powered productivity app that converts natural speech into actionable tasks, reminders, and notes—helping users stay organized without slowing down."
...
// export default function Hero() {
//   return (
//     <div className="relative w-full h-[560px] lg:h-[663px] overflow-hidden">
//       {/* Background video */}
//       <video
...
//           {" "}
//           Your <span className="text-[#FF9500]">
//             Voice-First Productivity{" "}
//           </span>{" "}
//           App That Turns
//           <br /> Natural Speech Into Action
//         </h1>
//         <PageSubtitle
//           text="SayTask is a conversational AI-powered productivity app that converts natural speech into actionable tasks, reminders, and notes—helping users stay organized without slowing down."
//           className="text-[#CAD5E2] mt-2 lg:mt-6 leading-8 lg:w-[60%] mx-auto"
//         />
//       </div>
//     </div>
//   );
