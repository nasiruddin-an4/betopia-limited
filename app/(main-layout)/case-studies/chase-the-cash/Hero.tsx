...
export default function Hero() {
  return (
    <div className="relative w-full h-125 lg:h-145 xl:min-h-screen   overflow-hidden">
      ...
      <Image
        alt="media"
        className="absolute top-0 left-0 w-full h-full object-cover lg:object-right lg:pt-16"
        src="/hero/c2.png"
        width={1660}
        height={563}
      />
      ...
      <div className="relative z-10 flex flex-col mt-10 lg:-mt-32  justify-center h-full text-white px-4 sm:px-6 md:px-10 lg:px-16 2xl:pt-[5%] lg:pt-[35%] xl:pt-[28%]">
        ...
        <div className="max-w-360 w-full mx-auto">
          ...
          >
            CHASE THE CASH SA is Your
            <br />
            {}
            <span className="text-[#FF9500]">AI Assistant</span>
          </h1>
          <PageSubtitle
            text="An innovative mobile app that transforms the thrill of treasure hunting into an engaging, gamified adventure with puzzles, QR scans, and real rewards."
