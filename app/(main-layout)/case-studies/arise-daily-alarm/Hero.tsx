...
export default function Hero() {
  return (
    <div className="relative w-full h-125 lg:h-145 xl:min-h-screen   overflow-hidden">
      ...
      <Image
        alt="media"
        className="absolute top-0 left-0 w-full h-full object-cover object-center lg:mt-10"
        src="/hero/a2.png"
        width={1660}
        height={563}
      />
      ...
      <div className="relative z-10 flex flex-col mt-10 lg:-mt-32  justify-center h-full text-white px-4 sm:px-6 md:px-10 lg:px-16 2xl:pt-[5%] lg:pt-[35%] xl:pt-[28%]">
        <div className="max-w-360 w-full mx-auto mb-10 flex flex-wrap items-center gap-3 pb-3 border-b border-white">
          ...
          <Link
            ...
            href="/case-studies/arise-daily-alarm"
          >
            Arise
          </Link>
        </div>
        ...
        <div className="max-w-360 w-full mx-auto">
          ...
          >
            Daily Devotional Alarm is Your Daily
            <br />
            {}
            <span className="text-[#FF9500]"> Wake-Up with Purpose</span>
          </h1>
          <PageSubtitle
            text="A gentle devotional alarm that helps you wake up calmly, reflect spiritually, and begin your day with intention."
...
//         >Daily {' '}<span className="text-[#FF9500]">Devotional Alarm  </span>   is Your Daily <br />  Wake-Up with Purpose
//         </h1>
//    <PageSubtitle
//             text="A gentle devotional alarm that helps you wake up calmly, reflect spiritually, and begin your day with intention."
