    ...
    <div className="relative w-full h-125 lg:h-145 xl:min-h-screen   overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col mt-10 lg:-mt-32  justify-center h-full text-white px-4 sm:px-6 md:px-10 lg:px-16 2xl:pt-[5%] lg:pt-[35%] xl:pt-[28%]">
        ...
        <div className="max-w-360 w-full mx-auto">
          ...
          >
            Your AI Guide for a Seamless
            <br />
            {}
            <span className="text-[#FF9500]">Umrah Journey</span>
          </h1>
          <PageSubtitle
            text="Embark on your spiritual journey with confidence using Umrah Guide & Connection, the ultimate app designed to assist pilgrims at every step of their Umrah"
...
// export default function Hero() {
//   return (
//     <div className="relative w-full h-[500px] lg:h-[630px] overflow-hidden">
//       {/* Background video */}
//       <video
...
//         >
//           Umrah Guide &  <span className="text-[#FF9500]"> Connection </span> <br /> Your AI Assistant Guiding You Through <br /> the Sacred Journey of Umrah
//         </h1>
//  <PageSubtitle
//           text="Embark on your spiritual journey with confidence using Umrah Guide & Connection, the ultimate app designed to assist pilgrims at every step of their Umrah"
