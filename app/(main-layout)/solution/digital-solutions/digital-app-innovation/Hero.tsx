      ...
      <div className="relative z-10 flex flex-col mt-10 lg:-mt-32  justify-center h-full text-white px-4 sm:px-6 md:px-10 lg:px-16 2xl:pt-[5%] lg:pt-[35%] xl:pt-[28%]">
        <div className="max-w-[1440px] w-full mx-auto mb-10 flex flex-wrap items-center gap-3 pb-3 border-b border-white">
          ...
          <Link
            ...
            href="/solution/digital-solutions/digital-app-innovation"
          >
...
Build Smarter
            <br />
            {}
            <span className="text-[#FF9500]">Digital Experiences.</span>
          </h1>
          <PageSubtitle
            text="End-to-end digital and application innovation solutions that modernize applications, automate processes, and deliver scalable, user-centric digital experiences across the enterprise."
...
//           End-to-end digital and application innovation solutions that modernize
//           applications, automate processes, and deliver scalable, user-centric
//           digital experiences across the enterprise.
//         </p>
