      ...
      <div className="relative z-10 flex flex-col mt-10 lg:-mt-32  justify-center h-full text-white px-4 sm:px-6 md:px-10 lg:px-16 2xl:pt-[5%] lg:pt-[35%] xl:pt-[28%]">
        <div className="max-w-[1440px] w-full mx-auto mb-10 flex flex-wrap items-center gap-3 pb-3 border-b border-white">
          ...
          <Link
            ...
            href="/solution/digital-solutions/ai-solutions"
          >
       AI Solutions
          </Link>
        </div>
        ...
        <div className="max-w-[1440px] w-full mx-auto">
          ...
          >
         Transform Intelligence into
            <br />
            {}
            <span className="text-[#FF9500]">Business Advantage</span>
          </h1>
          <PageSubtitle
            text="End-to-end AI solutions that enable intelligent decision-making, automation, and innovation—helping enterprises unlock value from data, processes, and digital experiences responsibly and at scale."
...
//         >
//            Transform Intelligence into <br />
//           <span className="text-[#FF9500]"> Business Advantage</span>
//         </h1>

//         <p className="mt-4 sm:mt-6 text-lg md:text-xl xl:text-2xl text-[#CAD5E2] md:max-w-[75%] mx-auto px-2 sm:px-4">
//        End-to-end AI solutions that enable intelligent decision-making, automation, and innovation—helping enterprises unlock value from data, processes, and digital experiences responsibly and at scale.
//         </p>
