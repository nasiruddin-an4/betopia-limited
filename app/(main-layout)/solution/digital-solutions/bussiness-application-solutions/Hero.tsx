      ...
      <div className="relative z-10 flex flex-col mt-10 lg:-mt-32  justify-center h-full text-white px-4 sm:px-6 md:px-10 lg:px-16 2xl:pt-[5%] lg:pt-[35%] xl:pt-[28%]">
        <div className="max-w-[1440px] w-full mx-auto mb-10 flex flex-wrap items-center gap-3 pb-3 border-b border-white">
          ...
          <Link
            ...
            href="/solution/digital-solutions/bussiness-application-solutions"
          >
        ...
        <div className="max-w-[1440px] w-full mx-auto">
          ...
          >
          Powering Digital Businesses with
            <br />
            {}
            <span className="text-[#FF9500]">Intelligent Applications</span>
          </h1>
          <PageSubtitle
            text="We help organizations modernize core operations, automate processes, gain actionable insights, and deliver superior customer and employee experiences."
...
// export default function Hero() {
//   return (
//     <section className="relative flex flex-col justify-end items-center  h-[600px] lg:h-[666px] overflow-hidden text-white pt-10 md:pt-20 pb-10 md:pb-[72px]">
//       {/* Video Background */}
//       <video
...
//         We help organizations modernize core operations, automate processes, gain actionable insights, and deliver superior customer and employee experiences.
//          </p>
