      ...
      <div className="relative z-10 flex flex-col mt-10 lg:-mt-32  justify-center h-full text-white px-4 sm:px-6 md:px-10 lg:px-16 2xl:pt-[5%] lg:pt-[35%] xl:pt-[28%]">
        <div className="max-w-[1440px] w-full mx-auto mb-10 flex flex-wrap items-center gap-3 pb-3 border-b border-white">
          ...
          <Link
            ...
            href="/solution/hybrid-cloud-and-devops/devops-solutions"
          >
          DevOps Solutions
          </Link>
        </div>
        ...
        <div className="max-w-[1440px] w-full mx-auto">
          ...
          >
           Accelerate Innovation. Improve Reliability.
            <br />
            {}
            <span className="text-[#FF9500]">Deliver at Scale.</span>
          </h1>
          <PageSubtitle
            text="Modern DevOps solutions that enable faster releases, stronger security, and scalable operations across any environment."
...
//           text-2xl md:text-4xl lg:text-[64px]   "
//         >
//          Accelerate Innovation. Improve Reliability. <br />
//           <span className="text-[#FF9500]"> Deliver at Scale. </span>
//         </h1>

//         <p className="mt-4 sm:mt-6 text-lg md:text-xl xl:text-2xl text-[#CAD5E2] md:max-w-[55%] mx-auto px-2 sm:px-4">
// Modern DevOps solutions that enable faster releases, stronger security, and scalable operations across any environment.
//   </p>
