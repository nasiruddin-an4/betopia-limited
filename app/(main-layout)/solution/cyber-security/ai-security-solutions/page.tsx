...
export const metadata: Metadata = {
  title:
    "AI Security Solutions for Enterprises | Trustworthy & Governed AI | Betopia Limited",

  description:
    "End-to-end AI security solutions protecting models, data, infrastructure, and AI operations with governance, compliance, and threat detection to enable trustworthy enterprise AI adoption by Betopia Limited.",
  ...
  keywords: [
    ...
    "AI threat detection and monitoring",
  ...
  alternates: {
    canonical: "https://betopialimited.com/solution/cyber-security/ai-security-solutions",
  },
  ...
  openGraph: {
    ...
    url: "https://betopialimited.com/solution/cyber-security/ai-security-solutions",
...
export const digitalAppInnovationwhyBetopiaContent: WhyBetopiaContent = {
  ...
  items: [
    {
      title: "AI, Cloud & Security Convergence Expertise",
      description:
...
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
  ...
  <path d="M7 10V7C7 5.67392 7.52678 4.40215 8.46447 3.46447C9.40215 2.52678 10.6739 2 12 2C13.3261 2 14.5979 2.52678 15.5355 3.46447C16.4732 4.40215 17 5.67392 17 7V10" stroke="#F59500" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    ...
    {
      title: "End-to-End AI Coverage Across Models & Infrastructure",
...
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
  <path d="M20 13.0004C20 18.0004 16.5 20.5005 12.34 21.9505C12.1222 22.0243 11.8855 22.0207 11.67 21.9405C7.5 20.5005 4 18.0004 4 13.0004V6.00045C4 5.73523 4.10536 5.48088 4.29289 5.29334C4.48043 5.10581 4.73478 5.00045 5 5.00045C7 5.00045 9.5 3.80045 11.24 2.28045C11.4519 2.09945 11.7214 2 12 2C12.2786 2 12.5481 2.09945 12.76 2.28045C14.51 3.81045 17 5.00045 19 5.00045C19.2652 5.00045 19.5196 5.10581 19.7071 5.29334C19.8946 5.48088 20 5.73523 20 6.00045V13.0004Z" stroke="#F59500" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    ...
    {
      title: "Secure-by-Design AI Architecture & Compliance",
      description:
...
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
  ...
  <path d="M9 12L11 14L15 10" stroke="#F59500" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    ...
    {
      title: "Enterprise & Cloud-Scale AI Adoption Experience",
      description:
...
export const digitalAppInnovation = [
  {
    ...
    description:
      "We protect AI models from manipulation, misuse, and adversarial attacks.",
    image: "/solution/cyber-security/ai-security-solutions/1.png",
    points: [
      "AI model integrity protection",
      "Defense against data poisoning and evasion attacks",
      "Secure training and validation pipelines",
    ],
  },
  {
    title: "Data Security for AI",
    description:
      "We safeguard sensitive data used to train and operate AI systems.",
    image: "/solution/cyber-security/ai-security-solutions/2.png",
    points: [
      "Protection of training and inference data",
      "Prevention of data leakage and unauthorized access",
      "Strong access control for AI datasets",
    ],
  },
  {
    title: "AI Infrastructure Security",
    description:
      "We secure the compute and platforms that power AI workloads.",
    image: "/solution/cyber-security/ai-security-solutions/3.png",
    points: [
      "Secure AI compute environments (GPU, TPU, and accelerators)",
      "Protection across cloud and on-prem AI infrastructure",
      "Isolation and continuous monitoring of AI workloads",
    ],
  }, 
  {
    title: "AI Access & Identity Security",
    description:
      "We control who can access AI models, services, and data",
    image: "/solution/cyber-security/ai-security-solutions/4.png",
    points: [
      "Role-based access to AI systems",
      "Authentication of AI models and services",
      "Full auditability of AI access and usage",
    ],
  },
  {
    title: "Threat Detection & Monitoring for AI Systems",
    description:
      "We detect threats targeting AI workloads and behaviors.",
    image: "/solution/cyber-security/ai-security-solutions/5.png",
    points: [
      "Anomaly detection across AI workloads",
      "Continuous monitoring of model behavior and drift",
      "Detection of AI-specific attacks and abuse",
    ],
  }, 
  {
    title: "AI Supply Chain Security",
    description:
      "We secure the AI development and deployment supply chain.",
    image: "/solution/cyber-security/ai-security-solutions/6.png",
    points: [
      "Third-party AI model and component risk management",
      "Dependency integrity and provenance checks",
      "Secure sourcing of models and datasets",
    ],
  },
  {
    title: "AI Governance & Compliance",
    description:
      "We help organizations adopt AI responsibly and compliantly.",
    image: "/solution/cyber-security/ai-security-solutions/7.png",
    points: [
      "AI policy, ethics, and governance enforcement",
      "Alignment with regulatory and industry frameworks",
      "Transparency, explainability, and auditability",
    ],
  }, 
  {
    title: "AI Cloud Security Solutions",
    description:
      "We secure AI workloads deployed on cloud platforms.",
    image: "/solution/cyber-security/ai-security-solutions/8.png",
    points: [
      "Cloud-native protection for AI and ML services",
      "Secure machine learning platforms and pipelines",
      "Visibility and centralized control",
    ],
  },
  {
    title: "AI Endpoint & Edge Security",
    description:
      "We protect AI workloads running at the edge.",
    image: "/solution/cyber-security/ai-security-solutions/9.png",
    points: [
      "Security for edge-deployed AI models",
      "Secure inference environments",
      "Device integrity and tamper protection",
    ],
  }, 
];
  ...
  return (
    <div>
     ...
     AI Security Solutions
        ...
        description="We design and implement comprehensive AI security frameworks that protect artificial intelligence systems throughout their lifecycle—from data and model training to deployment, inference, and governance—while enabling safe and responsible AI innovation."
      ...
      <ClientValueStory title="“We don’t just protect AI systems — we enable organizations to adopt AI with confidence, trust, and governance, without exposing the business to new risks.”" />
            <CTA title="Ready to secure your AI initiatives and build trustworthy AI systems?" />
    </div>
  )
}