      ...
      <div className="relative z-10 flex flex-col mt-10 lg:-mt-32  justify-center h-full text-white px-4 sm:px-6 md:px-10 lg:px-16 2xl:pt-[5%] lg:pt-[35%] xl:pt-[28%]">
        <div className="max-w-[1440px] w-full mx-auto mb-10 flex flex-wrap items-center gap-3 pb-3 border-b border-white">
          ...
          <Link
            ...
            href="/solution/cyber-security/infrastructure-security"
          >
        ...
        <div className="max-w-[1440px] w-full mx-auto">
          ...
          <PageSubtitle
            text="Comprehensive infrastructure security solutions protecting virtualized, containerized, server, and cloud environments against modern cyber threats while ensuring resilience and business continuity."
...
// export default function Hero() {
//   return (
//     <section className="relative flex flex-col justify-end items-center  h-[610px] md:h-[666px] overflow-hidden text-white pt-10 md:pt-20 pb-10 md:pb-[72px]">
//       {/* Video Background */}
//       <video
...
//         >
//         Secure Your Infrastructure at <br />
//           <span className="text-[#FF9500]"> Every Layer</span>
//         </h1>

//         <p className="mt-4 sm:mt-6 text-lg md:text-xl xl:text-2xl text-[#CAD5E2] md:max-w-[75%] mx-auto px-2 sm:px-4">
//         Comprehensive infrastructure security solutions protecting virtualized, containerized, server, and cloud environments against modern cyber threats while ensuring resilience and business continuity.
//          </p>
