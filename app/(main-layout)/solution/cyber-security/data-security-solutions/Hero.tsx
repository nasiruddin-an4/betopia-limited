      ...
      <div className="relative z-10 flex flex-col mt-10 lg:-mt-32  justify-center h-full text-white px-4 sm:px-6 md:px-10 lg:px-16 2xl:pt-[5%] lg:pt-[35%] xl:pt-[28%]">
        <div className="max-w-[1440px] w-full mx-auto mb-10 flex flex-wrap items-center gap-3 pb-3 border-b border-white">
          ...
          <Link
            ...
            href="/solution/cyber-security/data-security-solutions"
          >
        ...
        <div className="max-w-[1440px] w-full mx-auto">
          ...
          <PageSubtitle
            text="End-to-end data security solutions that discover, protect, govern, and monitor sensitive data across databases, cloud platforms, big data systems, and enterprise environments."
...
//         >
//          Protect Your Most Critical   <br />Asset
//           <span className="text-[#FF9500]"> Your Data </span>
//         </h1>
