...
export default function Hero() {
  return (
    <div className="relative w-full h-[580px] lg:h-[810px] xl:min-h-screen   overflow-hidden">
      {/* Background video */}
      <Image
        alt="media"
      ...
      <div className="relative z-10 flex flex-col mt-10 lg:-mt-32  justify-center h-full text-white px-4 sm:px-6 md:px-10 lg:px-16 2xl:pt-[5%] lg:pt-[35%] xl:pt-[28%]">
        <div className="max-w-[1440px] w-full mx-auto mb-10 flex flex-wrap items-center gap-3 pb-3 border-b border-white">
          ...
          <Link
            ...
            href="/solution/cyber-security/iot-security-solutions"
          >
        ...
        PSecure Every Connected Device Across
          ...
          <PageSubtitle
            text="Comprehensive IoT security solutions that protect devices, networks, data, applications, and industrial systems ensuring visibility, control, and resilience across connected environments."
...
//         >
//       PSecure Every Connected Device Across <br /> 
//           <span className="text-[#FF9500]"> Your IoT Ecosystem </span>
//         </h1>
