      ...
      <div className="relative z-10 flex flex-col mt-10 lg:-mt-32  justify-center h-full text-white px-4 sm:px-6 md:px-10 lg:px-16 2xl:pt-[5%] lg:pt-[35%] xl:pt-[28%]">
        <div className="max-w-[1440px] w-full mx-auto mb-10 flex flex-wrap items-center gap-3 pb-3 border-b border-white">
          ...
          <Link
            ...
            href="/solution/cyber-security/identity-security-solutions"
          >
        ...
        <div className="max-w-[1440px] w-full mx-auto">
          ...
          <PageSubtitle
            text="Comprehensive identity security solutions that protect users, privileges, and access across enterprise environments using Zero Trust–aligned identity controls."
...
//           <span className="text-[#FF9500]"> Control Every Access </span>
//         </h1>

//         <p className="mt-4 sm:mt-6 text-lg md:text-xl xl:text-2xl text-[#CAD5E2] md:max-w-[75%] mx-auto px-2 sm:px-4">
//            Comprehensive identity security solutions that protect users,
//           privileges, and access across enterprise environments using Zero
//           Trust–aligned identity controls.
//         </p>
