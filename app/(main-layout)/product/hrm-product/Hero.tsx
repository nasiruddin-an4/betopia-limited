...
export default function Hero() {
  return (
    <div className="relative w-full  h-85 md:h-110 lg:h-152.5 2xl:min-h-screen  overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col -mt-10 lg:-mt-28  justify-center h-full text-white px-4 sm:px-6 md:px-10 lg:px-16 lg:pt-[20%] xl:pt-[15%] 2xl:pt-0">
        ...
        <div className="w-full 2xl:w-415 mx-auto">
          <h3 className=" text-white text-[28px] md:text-[32px] lg:text-[52px] font-bold">
            Betopia
            <span className="text-[#FF9500]"> HRM</span>{" "}
          </h3>
          <PageSubtitle
            text="A Secure, Scalable Human Resource Management System for Modern Enterprises"
            className="mt-2 lg:mt-7 text-start text-[#CAD5E2] md:w-[60%] lg:w-[45%] 2xl:w-[35%] "
          />
          <DemoButton />
        </div>
      </div>
...
// export default function Hero() {
//   return (
//     <div className="relative w-full  h-[320px] lg:h-[903px]  overflow-hidden">
//       <div className="h-20 bg-black"></div>
//       {/* Background video */}
//       <Image
//         alt="media"
...
//           <p
//             className={`text-lg md:text-xl xl:text-2xl mt-2 lg:mt-7 text-start text-[#CAD5E2] lg:w-[35%]  `}
//           >
//            A Secure, Scalable Human Resource Management System for Modern Enterprises
//           </p>
...
// //       className="relative flex flex-col justify-center items-center h-[800px] md:h-[607px] overflow-hidden text-white pt-20"
// //     >
// //       {/* Video Background */}
// //       <video
...
// //         >
// //           Transform Your Workforce Management with  <br />{" "}
// //           <span className="text-[#FF9500]">Intelligence & Automation</span>
// //         </h1>

// //         <p className="mt-4 sm:mt-6 text-lg md:text-xl xl:text-2xl font-normal  text-[#CAD5E2] max-w-[1100px] mx-auto px-2 sm:px-4">
// //           A centralized, secure, and scalable HRM platform that automates HR operations, streamlines attendance and leave management, and delivers real-time workforce insights for modern organizations.
// //         </p>
