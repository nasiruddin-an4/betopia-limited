...
export const Data = [
  {
    ...
    description: [
      "Real-time insights into workforce, attendance, and leave status",
      "Centralized view of key HR metrics",
      " Faster decision-making through actionable data",
    ],
    iconColor: "#2B7FFF",
    icon: (
      <svg
  ...
  },
  {
    ...
    description: [
      ...
      "Secure user management based on responsibilities",
      "Department-wise system navigation",
    ],
    iconColor: "#FF6900",
    icon: (
      <svg
  ...
  {
    bg: "bg-[#FF69001A]",
    title: "Organization & Administration Management",
    description: [
      "Company and multi-location setup",
      "Bank and branch configuration",
      "Organization-wide HR rule management",
    ],
    iconColor: "#FF6900",
    icon: (
      <svg
  ...
  },
  {
    ...
    description: [
      ...
      "Employment structure and designation setup",
  ...
  },
  {
    ...
    description: [
      "Attendance device (biometric) integration",
      "Manual attendance applications with approval workflow",
      "Shift categories and attendance rule configuration",
    ],
    iconColor: "#FF6900",
    icon: (
      <svg
  ...
  {
    bg: "bg-[#FEF2F2]",
    title: "Scheduling & Shift Planning",
    description: [
      "Shift category and definition setup",
      "Employee-wise shift assignment",
      "Support for multi-shift and rotation-based environments",
    ],
    iconColor: "#FF6900",
    icon: (
      <svg
...
const Card = ({ bg, title, description, icon }: CardProps) => {
  return (
    <div
      className={`p-9 rounded-2xl border hover:shadow-xl shadow-[#ffcd8d] border-gray-200 ${bg}`}
    >
...
export default function CorePlatform() {
  return (
    <div className="max-w-415 mx-auto py-16 px-4">
      ...
      <p className="mt-4 text-lg md:text-xl xl:text-2xl text-center font-normal  text-[#45556C] mx-auto max-w-250 px-2 sm:px-4">
