...
export const testimonials: Testimonial[] = [
  {
    ...
    message:
      "Betopia ERP connects your entire business into one intelligent system—improving efficiency, visibility, and control across every department..",
    verified: true,
  },
  {
    id: 2,
    ...
    message:
      "From booking to final delivery,It delivers . Their support team is responsive, and shipments always arrive on time.",
    verified: true,
  },
  {
    id: 3,
