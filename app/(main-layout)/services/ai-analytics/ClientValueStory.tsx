...
export default function ClientValueStory() {
  return (
    <div className="bg-[#C27AFF1A] relative py-10">
      ...
      <div className="w-[88vw] md:max-w-295.5 mx-auto bg-white rounded-lg p-5 md:p-18.75 shadow-xl relative">
        <div className="w-13.75 h-13.75 bg-linear-to-r from-[#2B7FFF]  to-[#AD46FF] rounded-2xl absolute -top-4 -left-4 flex items-center justify-center">
          <svg
        ...
        <h3 className="text-xl xl:text-[36px] font-bold z-10 mt-5">
          “We turn your data into action — building apps that think, predict,
          and recommend, delivering measurable business outcomes.”
        </h3>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-7 mt-10 pb-12 border-b border-gray-200">
          {/*  */}
          <div className="p-7 space-y-3 bg-[#F9FAFB] rounded-xl border border-[#F3F4F6]">
            <div className="w-13.75 h-13.75 bg-linear-to-r from-[#AD46FF]  to-[#F6339A] rounded-xl flex items-center justify-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="28"
                height="28"
          ...
          {/*  */}
          <div className="p-7 space-y-3 bg-[#F9FAFB] rounded-xl border border-[#F3F4F6]">
            <div className="w-13.75 h-13.75 bg-linear-to-r from-[#F6339A]  to-[#FF6900] rounded-xl flex items-center justify-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="28"
                height="28"
          ...
          {/*  */}
          <div className="p-7 space-y-3 bg-[#F9FAFB] rounded-xl border border-[#F3F4F6]">
            <div className="w-13.75 h-13.75 bg-linear-to-r from-[#FF6900]  to-[#FB2C36] rounded-xl flex items-center justify-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="28"
                height="28"
