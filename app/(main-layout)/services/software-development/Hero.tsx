    ...
    <div className="relative w-full   h-[580px]  xl:h-[750px]   2xl:min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col mt-10 lg:-mt-32  justify-center h-full text-white px-4 sm:px-6 md:px-10 lg:px-16 lg:pt-[32%] xl:pt-[28%] 2xl:pt-[5%]">
       ...
       <div className="lg:w-[1440px] mx-auto">
          ...
          <PageSubtitle
            text="Software is the backbone of digital business. Betopia Limited helps organizations design, build, modernize, and scale software solutions that drive efficiency, innovation, and competitive advantage. Our software development services combine engineering excellence with business insight to deliver reliable, secure, and future-ready digital solutions."
