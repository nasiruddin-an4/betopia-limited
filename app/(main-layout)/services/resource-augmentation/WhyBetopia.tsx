...
import { ResourcewhyBetopiaFeatures } from "@/data/service";
    ...
    <div className="bg-[#f7f5ff] py-10 lg:py-20">
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-20 items-stretch">
          ...
          <div>
            <HeadingThree
              title="Why Betopia Limited for Resource Augmentation"
            ...
            <div className="mt-10 space-y-7">
              {ResourcewhyBetopiaFeatures.map((item, index) => (
                <WhyBetopiaFeature
                  key={index}
                  icon={item.icon}
                  text={item.text}
...
//               />
//               <PageSubtitle
//                 text="We ensure top-tier security, compliance, and innovative cloud services to help your business thrive in a competitive landscape."
...
//                    Enterprise-Ready Talent Pipeline
//                   </h5>
//                   <PageSubtitle
//                     text="Powered by the Betopia Leadership Institute, we develop skilled professionals ready to deliver from day one."
...
//                   </h5>
//                   <PageSubtitle
//                     text="Our teams integrate smoothly into your existing workflows, tools, and processes with minimal disruption."
//                     className="text-[#000000CC] mt-1"
//                   />
//                 </div>
//               </div>
...
//                 </h5>
//                 <PageSubtitle
//                   text="We provide high-quality global delivery models that optimize cost without compromising performance or standards."
//                   className="text-[#000000CC] mt-1"
//                 />
//               </div>
//             </div>
...
//                   Powered by the Betopia Leadership Institute, we develop
//                   skilled professionals ready to deliver from day one.
//                 </p>
//               </div>
//             </div>
//             <div className="bg-white rounded-xl px-4 py-6 flex items-center gap-3 hover:bg-gray-50 hover:shadow-lg mt-7">
...
//                 </h5>
//                 <p className="text-sm lg:text-base text-[#00000099] font-normal mt-1">
//                   Our teams integrate smoothly into your existing workflows,
//                   tools, and processes with minimal disruption.
//                 </p>
//               </div>
//             </div>
//             <div className="bg-white rounded-xl px-4 py-6 flex items-center gap-3 hover:bg-gray-50 hover:shadow-lg mt-7">
...
//                 </h5>
//                 <p className="text-sm lg:text-base text-[#00000099] font-normal mt-1">
//                   We provide high-quality global delivery models that optimize
//                   cost without compromising performance or standards.
//                 </p>
//               </div>
//             </div>
//           </div>
