...
import { CloudwhatWeDoData } from "@/data/service";
    ...
    <Container>
      <div className="py-10 lg:py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-9 items-stretch px-3 xl:px-0 mt-6 lg:mt-12">
          {CloudwhatWeDoData.map((item, index) => (
...
//               />
//               <PageSubtitle
//                 text="Build modern, scalable applications designed for cloud environments from the ground up"
...
//               />
//               <PageSubtitle
//                 text="Transform legacy applications into modern, maintainable, and
//                   scalable solutions"
//                 className="mt-2 text-[#4A5565]"
//               />
//             </div>
...
//               />
//               <PageSubtitle
//                 text=" Expert deployment and management across Amazon Web Services  , Azure, and Google
//                   Cloud platforms"
//                 className="mt-2 text-[#4A5565]"
//               />
//             </div>
...
//               />
//               <PageSubtitle
//                 text="24×7 managed operations with cost optimization and
