...
import { CyberwhyBetopiaFeatures } from "@/data/service";
    ...
    <div className="bg-[#f7f5ff] py-10 lg:py-20">
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-20 items-stretch">
          ...
          <div>
            <HeadingThree
              title="Why Betopia Limited for Cybersecurity"
              className="text-[#0A0A0A]"
              center={false}
            />
            <HeadingSix
              title="Practical security. Real resilience."
              className="text-[#0A0A0A]"
              center={false}
            />

            <div className="mt-10 space-y-7">
              {CyberwhyBetopiaFeatures.map((item, index) => (
                <WhyBetopiaFeature
                  key={index}
                  icon={item.icon}
                  text={item.text}
...
//                     24/7 Offshore SOC with U.S./EU Oversight
//                   </h5>
//                   <PageSubtitle
...
//                 <div>
//                   <h5 className="text-xl xl:text-[30px] font-semibold  text-black">
//                     ISO 27001, SOC 2, CMMC Compliance Ready
//                   </h5>
//                   <PageSubtitle
...
//               <div>
//                 <h5 className="text-xl xl:text-[30px] font-semibold  text-black">
//                   Industry-Specific Threat Intelligence & Security
//                 </h5>
//                 <PageSubtitle
//                   text="Industry-specific vertical playbooks for healthcare, BFSI, manufacturing"
//                   className="text-[#000000CC] mt-1"
//                 />
//               </div>
//             </div>
...
//                   Certified cloud experts with AWS, Azure, GCP partnerships
//                 </p>
//               </div>
//             </div>
//             <div className="bg-white rounded-xl px-4 py-6 flex items-center gap-3 hover:bg-gray-50 hover:shadow-lg mt-7">
...
//                 </h5>
//                 <p className="text-sm lg:text-base text-[#00000099] font-normal mt-1">
//                   ISO 27001, SOC 2, and cloud competency certified
//                 </p>
//               </div>
//             </div>
//             <div className="bg-white rounded-xl px-4 py-6 flex items-center gap-3 hover:bg-gray-50 hover:shadow-lg mt-7">
...
//                 </h5>
//                 <p className="text-sm lg:text-base text-[#00000099] font-normal mt-1">
//                   Industry-specific vertical playbooks for healthcare, BFSI,
//                   manufacturing
//                 </p>
//               </div>
//             </div>
