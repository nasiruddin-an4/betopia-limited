...
const BlogPost = () => {
  const shareUrl = 'https://betopialimited.com/news-item/betopia-llc-joins';
  const shareTitle = 'Betopia LLC Joins AmCham Bangladesh';
const newsItems = [
  {
    id: 1,
    category: "Sponsors",
    ...
    <div className="bg-gray-50 min-h-screen font-sans text-slate-900">
      ...
      <header className="max-w-4xl mx-auto pt-12 px-6">
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold mt-4 leading-tight">
          Bdcalling LLC Joins AmCham Bangladesh as an Official Member
        </h1>
      ...
      <main className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-3 gap-12 pb-20">
        ...
        <article className="lg:col-span-2 bg-white p-8 md:p-12 rounded-2xl shadow-sm leading-relaxed text-gray-700 space-y-6">
          <p>
            We are delighted to announce that Bdcalling LLC – a concern of Betopia Group – has officially become an affiliate member
            of the American Chamber of Commerce in Bangladesh (AmCham Bangladesh).
          </p>
          <p>
            The membership certificate was formally received by Ms. Sabina Akter, Chairman of Betopia Group, from Mr. Syed Ershad Ahmed,
            President of AmCham Bangladesh, at a special handover ceremony. The occasion was graced by distinguished guests, including
            Mr. Kaiser Mohammad Riyadh, Executive Director of AmCham Bangladesh, Mr. Muhammad Monir Hossain, Founder & CEO of Betopia
            Group, along with other respected members of both organizations.
          </p>
          <p>
            This affiliation represents a significant milestone for Bdcalling LLC, highlighting our continued efforts to expand globally
            and foster meaningful collaborations. As part of AmCham Bangladesh, Bdcalling looks forward to actively contributing to
            initiatives that encourage trade, investment, and knowledge exchange between Bangladesh and the international business
            community.
          </p>
          <p>
            We believe this partnership will further strengthen our vision of driving innovation, enhancing business excellence, and
            supporting the socio-economic development of Bangladesh. Being part of AmCham not only provides us with a valuable platform
            for global networking but also allows us to contribute to shaping a more vibrant business ecosystem in the country.
          </p>
          <p>
            Joining AmCham Bangladesh marks the beginning of a new chapter in Bdcalling’s journey, where we remain committed to promoting
            cross-border cooperation, exploring fresh opportunities, and building a sustainable future for businesses and communities
            alike.
          </p>
          ...
          <div className="flex justify-between items-center border-t pt-8 mt-8 text-sm font-medium text-gray-500">
            ...
            <Link 
              href="/news-item/shaping-the-future" 
              className="flex items-center gap-2 hover:text-orange-600 transition-colors duration-200"
            >
