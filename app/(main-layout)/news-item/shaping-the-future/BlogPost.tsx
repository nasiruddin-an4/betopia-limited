    ...
    <button className="w-10 h-10 rounded-full bg-[#e0e0e0] text-[#2b2b2b] flex items-center justify-center hover:scale-110 transition">
      ...
      <main className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-3 gap-12 pb-20">
        ...
        <article className="lg:col-span-2 bg-white p-8 md:p-12 rounded-2xl shadow-sm leading-relaxed text-gray-700 space-y-6">
          <p>
            Bdcalling IT Ltd CEO and Founder Muhammad Monir Hossain Speaks at SU CSE Fest 2025
          </p>
          <p>
            We are delighted to share that our esteemed Founder and CEO, Muhammad Monir Hossain, represented Bdcalling IT Ltd at the prestigious SU CSE Fest 2025, held on February 26–27 at
            Sonargaon University.
          </p>
          <p>
            In his inspiring keynote, Mr. Hossain emphasized the importance of training, industry development, job creation, and
            workforce advancement in shaping Bangladesh’s future. Addressing an audience of enthusiastic students, he encouraged
            them to embrace new opportunities, enhance their skills, and prepare to lead in the digital age.
            A highlight of his speech was the announcement of a 5-crore taka budget, dedicated to nurturing young entrepreneurs
            through a business case competition and supporting the development of future-ready digital startups. This initiative
            reflects Bdcalling’s strong commitment to empowering the next generation with the tools and resources they need to succeed.
          </p>
          <p>
            The event served as a remarkable platform for motivation, networking, and innovation, bridging the gap between academia
            and industry. Mr. Hossain’s presence and vision not only inspired the students but also reinforced Bdcalling IT Ltd’s
            role as a pioneer in fostering innovation and driving positive transformation in Bangladesh’s technology ecosystem.
          </p>
          <p>
            At Bdcalling, we remain committed to exploring new initiatives and empowering future leaders, ensuring that today’s aspirations
            become tomorrow’s achievements.
          </p>
