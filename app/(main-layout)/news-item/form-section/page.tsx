...
const RegistrationForm = () => {
  return (
    <>
    <div className="relative w-full h-[563px] overflow-hidden">
        {/* Background video */}
        <video
        ...
        <div className="relative z-10 flex flex-col mt-18 items-center justify-center h-full text-white text-center px-4 sm:px-6 md:px-10 lg:px-16">
            ...
            >
                Start Your Journey with <span className="text-[#FF9500]">Betopia</span>
            </h1>

            <p
                className="mt-4 sm:mt-6 text-base sm:text-sm md:text-sm lg:text-2xl font-normal  text-[#CAD5E2] max-w-[1000px] px-2 sm:px-4"
            >Take the first step towards a rewarding partnership.
            </p>
            <button className="flex mt-10 items-center gap-2 px-6 py-2.5 rounded-full border border-[#FF9500] border-b-4 bg-white/10 text-white transition-all hover:bg-white/20">
            ...
            <p
                className="mt-4 sm:mt-6 text-base sm:text-sm md:text-sm lg:text-2xl font-normal  text-[#CAD5E2] max-w-[1000px] px-2 sm:px-4"
            >Already in Collaboration? <a href="/login" className="underline text-[#FF9500]">Login here</a>
            </p>
    ...
    <div className="min-h-screen bg-linear-to-br from-[#FFF5F0] via-[#FDEEE5] to-[#FCE3D4] p-4 md:p-12 font-sans text-[#4A4A4A]">
        ...
        <form className="space-y-10">
          ...
          <section>
            ...
            <div className="space-y-6">
              <h3 className="flex items-center gap-2 font-bold text-sm">
                <span className="w-2 h-2 rounded-full bg-[#FDBA74]"></span> Business Details
              </h3>
              
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <FormGroup label="Full Name of the Organization" placeholder="Enter Full Name" />
                <FormGroup label="Email Address of the organization" placeholder="Enter Company Email" />
          ...
          <section>
            ...
            <div className="space-y-4">
              <h3 className="flex items-center gap-2 font-bold text-sm">
                <span className="w-2 h-2 rounded-full bg-[#FDBA74]"></span> Address Details
              </h3>
          ...
          <div className="space-y-8 pt-4">
            <label className="flex items-start gap-3 cursor-pointer">
              ...
              <span className="text-xs text-gray-600 leading-relaxed">
                I confirmed that I uploaded a valid government-issued photo ID. This ID includes my picture, signature, name, date of birth, and address.
              </span>
            </label>
