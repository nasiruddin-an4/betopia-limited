...
const BlogPost = () => {
  const shareUrl = 'https://betopialimited.com/news-item/leadership-transformation';
  const shareTitle = 'Leadership Transformation Program Builds Future Leaders..';
const newsItems = [
  {
    id: 1,
    category: "Sponsors",
  ...
  return (
    ...
    <button className="w-10 h-10 rounded-full bg-[#e0e0e0] text-[#2b2b2b] flex items-center justify-center hover:scale-110 transition">
      ...
      {/* 2. Featured Image */}
      {/* <div className="max-w-[1480px] mx-auto px-6 mb-12 md:h-auto">
        <img 
          src="/news/news-img-7.png" 
          className="w-full rounded-2xl shadow-lg object-cover height-[200px] md:height-[200px]" 
          alt="Featured"
        />
      </div> */}
      ...
      <main className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-3 gap-12 pb-20">
        ...
        <article className="lg:col-span-2 bg-white p-8 md:p-12 rounded-2xl shadow-sm leading-relaxed text-gray-700 space-y-6">
          <p>
            Empowering New Managers to Become Confident LeadersBetopia Group, a Bangladesh-based conglomerate dedicated to unleash
            the limitless potential of young leaders to shape a transformative and prosperous society, has successfully hosted a
            training program titled ‘Leadership Transformation Program’.
          </p>
          <p>
            The session was facilitated by Mr. Rashed Mujib Noman, an accomplished trainer with over 25 years of international
            experience across Boeing, Augmedix, and various startups.
          </p>
          <p>
            Mr. Noman who presently serving as the Country Director of Augmedix Bangladesh led the workshop at Betopia’s newly built,
            fully equipped conference room at Aqua Tower, Mohakhali.
          </p>
          <p>
            The workshop was graced by the presence of Muhammad Monir Hossain, Founder & CEO of Betopia Group; Sabina Akter, Chairman
            of Betopia Group; and Md. Ibrahim Khalil, Head of HR and Admin, alongside the company’s promising young leaders.Designed
            as a highly practical, case-driven training, the program was tailored for first-time managers and high-potential team
            members preparing to step into leadership roles.
          </p>
          <p>
           Emerging future leaders from across the Betopia Group actively took part in this immersive learning experience.
          </p>
          <p>
            Spanning a full day, the program featured five interactive sessions covering:
          </p>
          <p>
            • From Peer to Leader <br/>
            • Communication & Leadership<br/>
            • Team Building & Performance<br/>
            • Time & Conflict Management<br/>
            • Coaching & Growth
          </p>
          <p>
            Participants showed great enthusiasm for topics such as building a leadership mindset, effective delegation,
            managing peer relationships, setting SMART goals, and career development planning.
          </p>
          <p>
            Key outcomes of the program included:
          </p>
          <p>
            • Prioritizing and managing time effectively with practical tools<br/>
            • Mastering the art of effective delegation without micromanaging<br/>
            • Identifying root causes of workplace conflict<br/>
            • Learning structured methods to resolve conflicts
          </p>
