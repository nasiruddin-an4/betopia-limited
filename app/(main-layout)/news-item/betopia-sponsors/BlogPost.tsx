...
const BlogPost = () => {
  const shareUrl = 'https://betopialimited.com/news-item/betopia-sponsors';
  const shareTitle = 'Bdcalling Sponsors Odoo Business Show 2025';
const newsItems = [
  {
    id: 1,
    category: "Sponsors",
  ...
  return (
    <div className="bg-gray-50 min-h-screen font-sans text-slate-900">
      ...
      <div className='border-b border-gray-200 px-7 lg:px-0'>
        <nav className="max-w-7xl w-11/12 mx-auto  flex items-center space-x-2 text-sm text-slate-500 py-4">
            ...
            <span>/</span>
            <span className="font-bold text-slate-900">Sponsors</span>
        </nav>
      </div>
      {/* 1. Header Section */}
      <header className="max-w-4xl mx-auto pt-12 px-6">
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold mt-4 leading-tight">
          Bdcalling Sponsors Odoo Business Show 2025
        </h1>
    ...
    <button className="w-10 h-10 rounded-full bg-[#e0e0e0] text-[#2b2b2b] flex items-center justify-center hover:scale-110 transition">
      ...
      <main className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-3 gap-12 pb-20">
        ...
        <article className="lg:col-span-2 bg-white p-8 md:p-12 rounded-2xl shadow-sm leading-relaxed text-gray-700 space-y-6">
          <p>
            Bdcalling IT Ltd., a concern of Betopia Group, was proud to sponsor the prestigious Odoo Business Show 2025, held
            on 15th July at ICCB, Dhaka, Bangladesh. The event brought together Odoo users, partners, industry
            leaders, and future adopters to explore the limitless opportunities of digital transformation powered by
            Odoo’s ERP solutions.
          </p>
          <p>
            As the official sponsor, Bdcalling IT Ltd. had the privilege of showcasing its expertise in implementing
            As the fastest-growing Odoo partner in Bangladesh, Bdcalling has established itself as a trusted name in ERP implementation.
            In just six months, the company achieved the Odoo Silver Partner milestone—a clear reflection of its dedication, expertise,
            and strategic approach to delivering world-class Odoo solutions. This recognition not only highlights Bdcalling’s growth but
            also reinforces its commitment to empowering businesses through digital innovation.
          </p>
          <p>
            The event was graced by the esteemed presence of Muhammad Monir Hossain, Founder & CEO of Betopia Group, and Sabina Akter,
            Chairperson of Betopia Group. During the program, Mr. Hossain articulated his vision of aligning Bdcalling IT Ltd.
            with Odoo’s global strategy, ensuring that local businesses benefit from international best practices.
          </p>
          <p>
            Additionally, Shafiqul Islam, General Manager of Bdcalling, along with Md. Rumman Khan, Assistant General Manager,
            actively participated in the partner panel. They addressed critical queries from attendees, offering practical insights
            into Odoo implementation, business analysis, training, and long-term system adoption.
          </p>
          <p>
            Bdcalling IT Ltd. remains committed to supporting organizations in every phase of their digital transformation journey.
            From initial consultation and analysis to implementation, training, rollout, and continuous support—Bdcalling ensures a
            seamless path to operational excellence.
          </p>
          <p>
            The Odoo Business Show 2025 served as a remarkable platform to showcase Bdcalling’s achievements, share knowledge, and
            strengthen collaborations. With unwavering dedication, Bdcalling continues to drive business success in Bangladesh and
            beyond.
          </p>
          ...
          <div className="flex justify-between items-center border-t pt-8 mt-8 text-sm font-medium text-gray-500">
            ...
            <Link 
              href="/news-item/leadership-transformation" 
              className="flex items-center gap-2 hover:text-orange-600 transition-colors duration-200"
            >
