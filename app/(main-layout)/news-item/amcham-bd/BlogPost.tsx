...
const BlogPost = () => {
  const shareUrl = 'https://betopialimited.com/news-item/amcham-bd';
  const shareTitle = 'AmCham Bangladesh Hosts Breakfast Meeting on Strengthening Intellectual Property Rights';
const newsItems = [
  {
    id: 1,
    category: "Sponsors",
    ...
    <div className="bg-gray-50 min-h-screen font-sans text-slate-900">
      ...
      <header className="max-w-4xl mx-auto pt-12 px-6">
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold mt-4 leading-tight">
          AmCham Bangladesh Hosts Breakfast Meeting on Strengthening Intellectual Property Rights
        </h1>
      ...
      <main className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-3 gap-12 pb-20">
        ...
        <article className="lg:col-span-2 bg-white p-8 md:p-12 rounded-2xl shadow-sm leading-relaxed text-gray-700 space-y-6">
          <p>
            The American Chamber of Commerce in Bangladesh (AmCham) organized a Breakfast Meeting on Friday, July 18, at the Renaissance
            Hotel, Dhaka, with Ms. Shilpi Jha, Senior Commercial Specialist and Intellectual Property Policy Advisor for South Asia at
            the U.S. Patent and Trademark Office (USPTO), as the keynote guest.
          </p>
          <p>
            The session served as a dynamic platform for insightful discussions on the evolving landscape of intellectual property
            rights (IPR) in Bangladesh and the critical role of strong enforcement and collaboration in fostering innovation and
            business growth. Ms. Jha shared valuable perspectives on regional and global best practices, highlighting how Bangladesh
            can further align with international standards to create a robust and sustainable IPR framework.
          </p>
          <p>
            The event brought together distinguished participants, including Mr. Syed Ershad Ahmed, President of AmCham Bangladesh;
            Mr. Muhammad Monir Hossain, Founder and CEO of Betopia Group; Ms. Ju-Un Nahar Choudhury, Managing Director of Coca-Cola
            Bangladesh Ltd.; Mr. Abir Barua, Commercial Specialist at the U.S. Embassy Dhaka; and Dr. Mohammad Towhidul Islam, Professor
            of Law at the University of Dhaka. Their diverse experiences and expertise enriched the dialogue, underscoring the collective
            responsibility of government, private sector, academia, and international partners in advancing the country’s IPR ecosystem.
          </p>
          <p>
            Speaking at the event, Mr. Muhammad Monir Hossain emphasized the need for enhanced public-private collaboration, stressing
            that innovation and creativity can only thrive when supported by strong intellectual property protection. He pointed out
            that effective IPR policies not only safeguard creators and businesses but also build investor confidence and contribute
            to long-term national development.
          </p>
          <p>
            AmCham Bangladesh reaffirmed its commitment to fostering such dialogues, aiming to support Bangladesh’s journey toward a
            more competitive, knowledge-driven economy where innovation is protected, encouraged, and celebrated.
          </p>
