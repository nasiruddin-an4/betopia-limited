...
export default function CloudInfrastructureHero() {
  return (
      ...
      <div className="relative z-10 flex flex-col mt-10 lg:-mt-32  justify-center h-full text-white px-4 sm:px-6 md:px-10 lg:px-16 2xl:pt-[5%] lg:pt-[35%] xl:pt-[28%]">
        <div className="max-w-[1440px] w-full mx-auto mb-10 flex flex-wrap items-center gap-3 pb-3 border-b border-white">
          ...
          <Link
            ...
            href="/solution/hybrid-cloud-and-devops/cloud-infrastructure"
          >
        ...
        <div className="max-w-[1440px] w-full mx-auto">
          ...
          >
            Build Scalable, Secure & High Performance
            <br />
            {}
            <span className="text-[#FF9500]">Cloud Foundations</span>
          </h1>
          <PageSubtitle
            text="Enterprise-grade cloud infrastructure solutions covering compute, storage, networking, databases, backup, and performance management—designed for reliability, scalability, and business continuity."
...
// export default function CloudInfrastructureHero() {
//   return (
//     <section className="relative flex flex-col justify-end items-center  h-[650px] md:h-[666px] overflow-hidden text-white pt-10 md:pt-20 pb-10 md:pb-[72px]">
//       {/* Video Background */}
//       <video
...
//           Enterprise-grade cloud infrastructure solutions covering compute, storage, networking, databases, backup, and performance management—designed for reliability, scalability, and business continuity.
//         </p>
