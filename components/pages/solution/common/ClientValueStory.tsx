...
export default function ClientValueStory({ title }: ClientValueStoryProps) {
  return (
    <div className="bg-white relative py-10 px-4 md:px-0">
      <Image
      ...
      <div className="w-20 h-1 bg-[#9810FA] mx-auto mb-5"></div>
      <div className="max-w-[1182px] mx-auto  bg-white rounded-lg p-8 md:p-[75px] shadow-xl relative">
        <div className="md:size-[55px] size-12 bg-linear-to-r from-[#2B7FFF]  to-[#AD46FF] rounded-2xl absolute -top-4 md:-left-5 -left-2 flex items-center justify-center">
          <svg
        ...
        <Image
          ...
          className="absolute top-0 right-0 rounded-t-lg"
        />
        <h3 className="text-2xl md:text-3xl xl:text-[36px] font-semibold lg:leading-12 z-10">
         {title}
        </h3>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-7 mt-10 pb-6 md:pb-12 border-b-[1px] border-gray-200">
          {/*  */}
          <div className="md:p-7 p-4 space-y-2 md:space-y-3 bg-[#F9FAFB] rounded-xl border-[1px] border-[#F3F4F6]">
            ...
            <h6 className="text-lg md:text-xl xl:text-2xl text-[#101828] font-bold">
              Run Faster
            </h6>
            <p className="text-lg md:text-xl text-[#4A5565] font-normal">
        ...
        {/*  */}
<div className="grid md:grid-cols-3 gap-5 md:gap-[37px] md:mt-[38px] mt-5">
  <div className="flex items-center justify-center flex-col">
    <h1 className="bg-linear-to-r from-[#155DFC] to-[#9810FA] bg-clip-text text-transparent text-center font-bold text-3xl md:text-4xl xl:text-[52px]">
      3x
    </h1>
    <p className="text-base text-[#4A5565] text-center font-bold whitespace-nowrap">
      Performance Boost
    </p>
  </div>
  ...
  <div className="flex items-center justify-center flex-col">
    ...
    <p className="text-base text-[#4A5565] text-center font-bold">
      Cost Reduction
    </p>
  </div>
