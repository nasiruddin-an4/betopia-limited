      ...
      <div className="relative z-10 flex flex-col mt-10 lg:-mt-32  justify-center h-full text-white px-4 sm:px-6 md:px-10 lg:px-16 2xl:pt-[5%] lg:pt-[35%] xl:pt-[28%]">
        <div className="max-w-[1440px] w-full mx-auto mb-10 flex flex-wrap items-center gap-3 pb-3 border-b border-white">
          ...
          <Link
            ...
            href="/solution/dcim-network/data-center"
          >
        ...
        <div className="max-w-[1440px] w-full mx-auto">
          ...
          >
            ...
            <br />
            {}
            <span className="text-[#FF9500]">Future-Ready Data Center</span>
          </h1>
          <PageSubtitle
            text="Enterprise-grade compute, storage, virtualization, container, and hyperconverged infrastructure solutions designed for performance, availability, and long-term growth."
...
//            Enterprise-grade compute, storage, virtualization, container, and
//           hyperconverged infrastructure solutions designed for performance,
