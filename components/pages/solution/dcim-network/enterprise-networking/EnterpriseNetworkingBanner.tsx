...
export default function EnterpriseNetworkingBanner() {
  return (
    <div className="relative w-full h-[700px] lg:h-[810px] xl:min-h-screen  overflow-hidden">
      {/* Background video */}
      <Image
        alt="media"
      ...
      <div className="relative z-10 flex flex-col mt-10 lg:-mt-32  justify-center h-full text-white px-4 sm:px-6 md:px-10 lg:px-16 2xl:pt-[5%] lg:pt-[35%] xl:pt-[28%]">
        <div className="max-w-[1440px] w-full mx-auto mb-10 flex flex-wrap items-center gap-3 pb-3 border-b border-white">
          ...
          <Link
            ...
            href="/solution/dcim-network/enterprise-networking"
          >
        ...
        <div className="max-w-[1440px] w-full mx-auto">
          ...
          >
           Build Secure, High-Performance &
            ...
            <br /> 
            Always-Connected { }
            <span className="text-[#FF9500]">Enterprise Networks</span>
          </h1>
          <PageSubtitle
            text="Scalable LAN, WAN, wireless, data center, and secure access networking solutions designed to deliver reliability, visibility, and seamless connectivity across enterprise environments."
...
// export default function EnterpriseNetworkingBanner() {
//   return (
//     <section className="relative flex flex-col justify-end items-center  h-[635px] md:h-[696px] overflow-hidden text-white pt-10 md:pt-20 pb-10 md:pb-[72px]">
//       {/* Video Background */}
//       <video
...
//         >
//            Build Secure, High-Performance & <br /> Always-Connected 
//           <span className="text-[#FF9500]"> Enterprise Networks</span>
//         </h1>

//         <p className="mt-4 sm:mt-6 text-lg md:text-xl xl:text-2xl text-[#CAD5E2] md:max-w-[75%] mx-auto px-2 sm:px-4">
//            Scalable LAN, WAN, wireless, data center, and secure access
//           networking solutions designed to deliver reliability, visibility, and
//           seamless connectivity across enterprise environments.
//         </p>

//         <div className="flex justify-center gap-5 mt-[31px]">
//           <Link
