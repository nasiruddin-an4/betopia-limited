      ...
      <div className="relative z-10 flex flex-col mt-10 lg:-mt-32  justify-center h-full text-white px-4 sm:px-6 md:px-10 lg:px-16 2xl:pt-[5%] lg:pt-[35%] xl:pt-[28%]">
        <div className="max-w-[1440px] w-full mx-auto mb-10 flex flex-wrap items-center gap-3 pb-3 border-b border-white">
          ...
          <Link
            ...
            href="/solution/dcim-network/infrastructure-management"
          >
        ...
        <div className="max-w-[1440px] w-full mx-auto">
          ...
          >
            Ensure Stability, Visibility & Business Continuity
            <br />
            {}
          ...
          <PageSubtitle
            text="Enterprise-grade backup, disaster recovery, monitoring, and infrastructure management solutions designed to maximize uptime, reduce risk, and improve operational efficiency."
...
//       className="relative flex flex-col justify-end items-center h-[635px] md:h-[666px] overflow-hidden text-white pt-10 md:pt-20 pb-[35px]"
//     >
//       {/* Video Background */}
//       <video
...
//         >
//         Ensure Stability, Visibility & Business  <br />
// Continuity  {" "}
//           <span className="text-[#FF9500]">
// Across Your IT <br /> Infrastructure </span>
//         </h1>

//         <p className="mt-4 sm:mt-6 text-lg md:text-xl xl:text-2xl text-[#CAD5E2] md:max-w-[75%] mx-auto px-2 sm:px-4">
//          Enterprise-grade compute, storage, virtualization, container, and hyperconverged infrastructure solutions designed for performance, availability, and long-term growth.
//         </p>
