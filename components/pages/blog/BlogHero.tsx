    ...
    return (
        <div className="relative w-full h-[663px] overflow-hidden">
          ...
          text-3xl sm:text-4xl md:text-5xl lg:text-[68px] xl:text-[64px] leading-24"
                >
                    Spotlight  <span className='text-white '>from  Betopia Limited</span>
                </h1>

                <p
                    className="mt-4 sm:mt-6 text-base sm:text-lg md:text-xl lg:text-2xl font-normal  text-[#CAD5E2] max-w-[1000px] px-2 sm:px-4"
                >Uncover In-Depth Content and Strategies to Elevate Your Business with Our Latest Posts. Read Engaging Stories and Expert Insights.</p>
