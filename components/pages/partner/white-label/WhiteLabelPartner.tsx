...
const WhiteLabelPartner = () => {
  const benefits: PartnerBenefit[] = [
    {
      ...
      title: "Brand Use",
      description: "Own brand with backend support from Betopia",
    },
    {
      icon: (
        <svg width="38" height="38" viewBox="0 0 28 28" fill="none">
      ...
      description: "Full project delivery, Partner Success Manager, Training",
    },
    {
      icon: (
        <svg width="38" height="38" viewBox="0 0 28 28" fill="none">
  ...
  return (
    <section className="bg-linear-to-b from-[#FFF7ED] to-[#FFFFFF] pt-10">
      <div className="max-w-[1404px] mx-auto w-11/12">
        ...
        <div className="grid lg:grid-cols-2 gap-5 items-stretch">
          ...
          <div className="overflow-hidden relative h-full">
            ...
            <div className="relative h-full rounded-3xl overflow-hidden px-4 lg:px-0">
              <Image
                src="/partner/white-label/partner2.png"
                alt="White label"
                fill
          ...
          {/* Right content card */}
          <div className="bg-white rounded-3xl shadow-xl p-6 lg:p-8 h-full flex flex-col mx-4 md:mx-0">
            ...
            <p className="text-gray-600 mb-8 text-lg md:text-xl">
              Operates under own brand. Betopia provides full delivery as a
            ...
            <Link href="/partner/white-label/partner-form" className="mt-auto">
