...
export default function PartnerTestimonials() {
  ...
  return (
    <div className="relative py-10  px-4 overflow-hidden">
      ...
      <div className="relative max-w-[1404px]  w-11/12  mx-auto ">
        {/* Header */}
        <div className="text-center mb-10">
          <div className="inline-flex items-center gap-2 mb-4">
            <svg width="28" height="23" viewBox="0 0 28 23" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect x="5.44539" y="11.3125" width="15" height="15" rx="3.5" transform="rotate(-45 5.44539 11.3125)" stroke="#243855"/>
<rect y="11.3125" width="14" height="14" rx="4" transform="rotate(-45 0 11.3125)" fill="#6232F8"/>
</svg>
   ...
   <div className="">
          <h2 className="text-2xl md:text-[52px] font-bold ">
           Partner Success 
            ...
            <span className="text-[#FF9500]"> Stories </span>
          </h2>
              ...
              >
                ...
                <div className="flex items-end gap-4 mb-6">
                  <div className="relative border border-[#D8D8D8] p-2 rounded-full">
                    ...
                    />
                    <div className="absolute bottom-2 -left-1 bg-[#FF9500] rounded-full p-1.5">
                     <svg
  ...
  <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" />
                ...
                <div className="flex gap-1">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <svg key={i} className="w-5 h-5 text-[#FEB72B] fill-current" viewBox="0 0 20 20">
              ...
              {testimonials.map((_, index) => (
                <button
                  ...
                  className={`w-2.5 h-2.5 rounded-full transition-all duration-300 ${
                    index === currentIndex ? 'bg-[#FF9500] w-8' : 'bg-gray-300 hover:bg-gray-400'
                  }`}
                />
              ))}
            </div>
