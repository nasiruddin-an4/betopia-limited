...
export default function WhiteLabelPartnership() {
  return (
    <div className="relative w-full h-[763px] overflow-hidden">
            {/* Background video */}
            <video
                className="absolute top-0 left-0 w-full h-full object-cover"
                src="/videos/white-label-partnership.mp4"
                autoPlay
                loop
                muted
                playsInline
          ...
          text-3xl sm:text-4xl md:text-5xl lg:text-[68px] xl:text-[64px] leading-24"
                >
                    Grow Your <span className='text-[#FF9500] '>Business</span>  with Betopia <br /> White-Label   <span className='text-[#FF9500] '> Solutions</span>
                </h1>

                <p
                    className="mt-4 sm:mt-6 text-base sm:text-lg md:text-xl lg:text-2xl font-normal  text-[#CAD5E2] max-w-[1000px] px-2 sm:px-4"
                >Offer enterprise-grade technology under your own brand while Betopia delivers end-to-end solutions. Focus on client relationships, we handle the tech.</p>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3  md:gap-4 mt-8 sm:mt-10 lg:mt-14">
                    <Link href="/news">
                        ...
                        >Apply as a White-Label Partner
