...
export default function NewsMedia({ data }: Props) {
            ...
            >
              ...
              <div className="hidden lg:block lg:col-span-4 space-y-6">
                <h2 className="text-3xl font-medium leading-snug">
                  Betopia News & Media – Updates, Events & Press Resources
                </h2>
                <p className="text-gray-400 text-lg leading-relaxed max-w-sm">
                  Stay updated with the latest from Betopia Limited. Explore
                  company news, event highlights, press releases, and our Media
                  Kit...
                </p>
                <Link
                  href="/news-item"
