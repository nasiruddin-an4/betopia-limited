...
import { FaArrowRight, FaCogs, FaFingerprint, FaHandshake, FaRobot, FaTag, FaUserTie, FaVoteYea } from "react-icons/fa";
import { FiCloud } from "react-icons/fi";
import { LuBrain, LuShieldCheck } from "react-icons/lu";
import { useEffect, useState } from "react";
import { usePathname } from "next/navigation";

export const AiProductMenu = () => {
...
const isProductActive = pathname.startsWith("/product");
  ...
  return (
    <Dropdown
      ...
      placement="bottom"
      popupRender={() => (
        <div className="bg-black xl:bg-[#1a1d24] py-2 px-2 xl:py-10 xl:px-12 rounded-xl shadow-2xl border border-gray-800 xl:w-[20vw] overflow-y-auto h-[500px] xl:h-auto">
